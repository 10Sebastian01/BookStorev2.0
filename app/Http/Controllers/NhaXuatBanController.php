...
class NhaXuatBanController extends Controller
{
	...
	{
		$hangsanxuat = NhaXuatBanController::all(); //truy vấn dữ liệu từ model hãng sản xuất
	...
	{
		$hangsanxuat = NhaXuatBanController::find($id);
	...
	public function postSua(Request $request, $id)
	{
		...
		{
			// Xóa file cũ
			$orm = NhaXuatBanController::find($id);
	...
	{
		return Excel::download(new HangSanXuatExport, 'danh-sach-HSX.xlsx');
	}
}