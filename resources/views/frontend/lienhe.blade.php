                ...
                <div class="card h-100">
                    <div class="card-body text-center">
                        ...
                        <ul class="list-unstyled fs-sm mb-0">
                            <li>
                                <span class="text-muted me-1">Bán hàng:</span>
                                <a class="nav-link-style" href="mailto:customer@larashop.vn">customer@larashop.vn</a>
                            </li>
                            <li class="mb-0">
                                <span class="text-muted me-1">Hỗ trợ kỹ thuật:</span>
                                <a class="nav-link-style" href="mailto:support@larashop.vn">support@larashop.vn</a>
                            </li>
                        </ul>
                    </div>
                </div>
        ...
        <div class="row g-0">
            ...
            <div class="col-lg-6 px-4 px-xl-5 py-5 border-top">
                ...
                <form class="needs-validation mb-3" novalidate>
                    <div class="row g-3">
                        <div class="col-sm-6">
                            <label class="form-label" for="HoVaTen">Họ và tên:&nbsp;<span
                        ...
                        <div class="col-sm-6">
                            ...
                            <input class="form-control" type="email" id="Email" placeholder="nguyenan@email.com"
                                   required/>
                            <div class="invalid-feedback">Địa chỉ email không được bỏ trống!</div>
                        </div>
                        <div class="col-sm-6">
                            <label class="form-label" for="DienThoai">Điện thoại:&nbsp;<span
                                        class="text-danger">*</span></label>
                        ...
                        <div class="col-12">
                            <label class="form-label" for="NoiDung">Nội dung tin nhắn:&nbsp;<span
                                        class="text-danger">*</span></label>
                            <textarea class="form-control" id="NoiDung" rows="6"
                                      placeholder="Hãy mô tả chi tiết yêu cầu của bạn" required></textarea>
