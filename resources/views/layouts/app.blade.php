                    ...
                    <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                        <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu">
                                <li class="nav-item">
                                    <a class="dropdown-item" href="{{ route('admin.loaisach') }}"><i class="fa-solid fa-diagram-project"></i> Loại sách</a>
                                </li>
                                <li class="nav-item">
                                    <a class="dropdown-item" href="{{ route('admin.nhaxuatban') }}"><i class="fa-solid fa-industry"></i> Nhà xuất bản</a>
                                </li>
                                <li class="nav-item">
                                    <a class="dropdown-item" href="{{ route('admin.sach') }}"><i class="fa-solid fa-box"></i> Sách</a>
                                </li>
                                <li class="nav-item">
